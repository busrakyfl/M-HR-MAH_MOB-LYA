<%@ Page Title="" Language="C#" MasterPageFile="~/MASTER.master" AutoEventWireup="true" CodeFile="Cok_Amacli.aspx.cs" Inherits="Cok_Amacli" %>
         ...
         <tr>
             ...
             <td>
                 <asp:DropDownList ID="DropDownList1" runat="server">
                     ...
                     <asp:ListItem>Yatak</asp:ListItem>
   ...
   <li><a href="urun.aspx">Mobilya</a></li>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="m_boyut" HeaderText="MOBİLYA BOYUT" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [cok_amacli]"></asp:SqlDataSource>
    </div>
</asp:Content>
