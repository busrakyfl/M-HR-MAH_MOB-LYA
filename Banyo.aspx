<%@ Page Title="" Language="C#" MasterPageFile="~/MASTER.master" AutoEventWireup="true" CodeFile="Banyo.aspx.cs" Inherits="banyo" %>
         ...
         <tr>
             ...
             <td class="auto-style1">
                 <asp:DropDownList ID="DropDownList1" runat="server">
                     ...
                     <asp:ListItem>Dolap</asp:ListItem>
                 </asp:DropDownList>
             </td>
         </tr>
         <tr>
   ...
   <li><a href="urun.aspx">Mobilya</a></li>
    ...
    <div id="liste">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [banyo]"></asp:SqlDataSource>
    </div>
</asp:Content>
