<%@ Page Title="" Language="C#" MasterPageFile="~/MASTER.master" AutoEventWireup="true" CodeFile="Yemek_Odasi.aspx.cs" Inherits="Yemek_Odasi" %>
         ...
         <tr>
             ...
             <td>
                 <asp:DropDownList ID="DropDownList1" runat="server">
                     ...
                     <asp:ListItem Value="Sehpa">Vitrin</asp:ListItem>
                 </asp:DropDownList>
             </td>
         </tr>
         <tr>
...
&nbsp;<asp:Button ID="Button5" runat="server" Text="SİL" />
&nbsp;&nbsp;
                 <asp:Button ID="Button6" runat="server" Text="DÜZENLE" />
             &nbsp;&nbsp;
   ...
   <li><a href="urun.aspx">Mobilya</a></li>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [yemek_odasi]"></asp:SqlDataSource>
    </div>
</asp:Content>
